...
此扩展合约，基于 LOVE20 扩展协议标准，让一个行动可以通过矿池的方式来参与行动铸币。

矿工可自由加入退出所选矿池，进行可验证的共识行动，矿池主每轮对矿工进行验证，矿工获得行动铸币激励，矿池主获得矿池服务铸币激励，支持此行动的治理者，通过不信任投票降低矿池整体收益，监督和惩罚作弊或违背行动验证规则的矿池主。
